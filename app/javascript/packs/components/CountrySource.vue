<template>
  <div>
    ...
    <div :key="countryName" class="card mt-5">
      <div class="card-header">
        <h5 class="card-title"><strong>{{countryName}}:</strong> How did you hear about this study?</h5>
      </div>
      <div class="card-body">
