<template>
  <div class="card mb-5" :key="'source-table'">
    <h5>
      Eligible participants recruited by source per week - completed the main
      block of the short survey or the long survey in its entirety
    </h5>
...
export default {
  ...
  methods: {
    ...
    fetchWeeklySourceData() {
      this.loaded = false;
      axios
        .get(`${this.$basePrefix}survey_responses/timeline`, {
