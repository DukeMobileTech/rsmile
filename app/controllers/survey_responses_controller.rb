class SurveyResponsesController < ApplicationController
  ...
  def new
    @survey_response = @participant.survey_responses.new
  end
  ...
  def create
    @survey_response = @participant.survey_responses.new(survey_response_params)
  ...
  private
    ...
    def set_survey_response
      @survey_response = @participant.survey_responses.find(params[:id])
    end
